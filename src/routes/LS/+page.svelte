<div id="intro">
    <img src="./committees/LK.jpg" alt="" id="post">
    <!-- <h1>DISEC</h1> -->
</div>
...
<div id="content">
    <div id="desc">
        <div id="img">
            <img src="./committees_logos/lk.png" alt="">
        </div>
        <div id="info">
            <h1>Lok Sabha</h1><br>
            <p>The Lok Sabha is the lower house of India's bicameral Parliament. Composed of representatives of people chosen by direct election, it legislates on national interest issues. As defined and formulated by the Constitution the nature of its legislation is legally binding throughout India, holding more power than its upper house.</p>
        </div>
    </div>

    <div id="agenda">
        <h1>Agenda</h1><br>
        <p>Promulgation of Bill for Uniform Civil Code</p>
    </div>
    <br><hr><br>
    ...
    <div id="bgguide">
        ...
        <div id="bgdesc">
            ...
            <br><br><a href="./guides/LS.pdf">View Background Guide →</a> <br><br></p>
        </div>
        <div id="preview">
...
<style>
    #intro{
        ...
        background-image: url("/committees_background/LK.png");
