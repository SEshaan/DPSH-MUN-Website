...
<div id="🧐">
	...
	<p style="color: #d0bea8;font-size:x-large">Lok Sabha and International Press (IP) can be found <a href="./Allocations_List">here</a><br><span style="font-size: medium;">Hover on countries to see allocations</span></p>
	<br />
